    ...
    for i in range(loop):
        for index_current in range(608):
            ...
            if p_i != 0:
                print("p_i = ", p_i)
                # input("sdf")
                index_7s, prob_normal_7s, directions_7s_01, max_p = cal_7directions_probability(states_index,
                                                                                                index_current)
...
if __name__ == "__main__":
    ...
    '''
    Import topography, vegetation and elevation data
    and use TVE information to build a status message containing 607 cells
    '''
