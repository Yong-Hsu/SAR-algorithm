...
class Transfer_matrix():
    ...
    def theta_sample_21s(self):
        ...
        self.TVS_transition_matrix = self.__993_to_21(self.T_transition_matrix, self.V_transition_matrix,
                                                      self.S_transition_matrix)
...
class Build_State():
    ...
    def __calculate_TVE(self):
        ...
        for y in range(self.H_num):
            ...
            pen_x = 2 * self.r - self.r * 0.75 * math.pow(-1,
                                                          y)  # (r / 4) * math.sqrt(3) * math.pow(-1, y + 1) + (r / 4) * math.sqrt(3) + r
            pen_x_ = pen_x
